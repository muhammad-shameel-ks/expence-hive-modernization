    ...
    for (const claim of CLAIMS) {
      await client.query(
        `INSERT INTO reimbursement_claims
          (id, organization_id, requester_id, reference, title, category, sub_category, remark, amount_minor, currency, expense_date, status, current_stage, current_actor_id, version, created_at, submitted_at, account_number, ifsc_code, comments)
         VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9, 'INR', $10, $11, $12, $13, 1, $14, $15, $16, $17, $18)
        ...
        [
          ...
          claim.amountMinor, claim.expenseDate, claim.status, claim.currentStage, claim.currentActorId, claim.createdAt, claim.submittedAt,
